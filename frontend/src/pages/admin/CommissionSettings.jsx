...
const CommissionSettings = () => {
    ...
    return (
        <div className="p-6">
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-3xl font-bold text-gray-900">Category Commission Settings</h1>
                <p className="text-gray-600 mt-1">Manage commission rates for product categories (2-10%)</p>
            </div>

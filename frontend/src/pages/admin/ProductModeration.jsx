    ...
    return (
        <div className="min-h-screen bg-slate-50">
            <div className="max-w-7xl mx-auto px-4 py-6 md:py-8 w-full max-w-full overflow-hidden">
                {/* Header */}
                <div className="mb-6">
                    <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Product Moderation</h1>
                    <p className="text-sm md:text-base text-gray-600 mt-1">Review and approve vendor products</p>
                </div>
